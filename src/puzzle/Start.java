...
public class Start{ //Bad name - This class arranges the changing parameters and runs testing scripts for 
	...
	public static float getSolveScore(BufferedImage inputImg ,String imgPath,int partSize, int sizeOverlap) throws ClassNotFoundException{
...
//		Global.SALIENCY_FACTOR = Global.parameters[Global.ParameterNames.saliencyFactorVals.ordinal()].getDoubleValue();
		...
		Global.geometricRelationsThreshold = (double)backup.parameters[Global.ParameterNames.geometricRelationsVals.ordinal()].getValue();
		Global.geometryKeyConstant = (double)backup.parameters[Global.ParameterNames.geometryKeyConstantVals.ordinal()].getValue();
	...
	public static void testingScript() throws ClassNotFoundException, FileNotFoundException, UnsupportedEncodingException{
	...
	public static void runTestsRecursively(int activeParameter,int imagesIndex) throws ClassNotFoundException{
